    ...
    <div class="container">
        <div class=" breadcrumb-link">
            <ul>
                ...
                <li>
                    <a class="active" href="{{route('sale')}}">بيع</a>
                </li>
            </ul>
        </div>
    </div>
                ...
                <form action="{{ route('sale.search') }}" method="GET">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-xs-12 col-sm-4">
                            ...
                            <select class="category form-control select2-hidden-accessible" name="area_id" aria-hidden="true">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-4">
                            ...
                            <select class="category form-control select2-hidden-accessible" name="type_id" aria-hidden="true">
                                <option label="Select Option"></option>
